...
class Utils {
    ...
    /**
     * Change given item_image view tint
     *
     * @param imageView target item_image view
    ...
    /**
     * Change given item_image view tint with animation
     *
     * @param image     target item_image view
